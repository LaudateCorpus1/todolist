...
/***/ function(module, exports, __webpack_require__) {
	...
	var _TodoStore = __webpack_require__(59);
	...
	var render = function render() {
	    _reactDom2.default.render(_react2.default.createElement(_TodoList2.default, { store: _TodoStore2.default }), document.getElementById("toDoListApp"));
	};

	_TodoStore2.default.subscribe(render);
	render();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _TodoListItem = __webpack_require__(38);

	var _TodoListItem2 = _interopRequireDefault(_TodoListItem);

	var _TodoListAdd = __webpack_require__(39);

	var _TodoListAdd2 = _interopRequireDefault(_TodoListAdd);

	var _TodoListItemEdit = __webpack_require__(40);

	var _TodoListItemEdit2 = _interopRequireDefault(_TodoListItemEdit);

	var _TodoVoiceControl = __webpack_require__(41);

	var _TodoVoiceControl2 = _interopRequireDefault(_TodoVoiceControl);

	var _reactDayPicker = __webpack_require__(44);

	var _reactDayPicker2 = _interopRequireDefault(_reactDayPicker);

	__webpack_require__(56);

	var _TodoStoreActions = __webpack_require__(58);

	var act = _interopRequireWildcard(_TodoStoreActions);
	...
	var TodoList = function (_React$Component) {
	    ...
	    function TodoList(props) {
	        ...
	        _this.state = { editableItemID: null };
	        _this.state = { messageToShow: "", messageTimer: null };
	        _this.state = { activeDays: [] };
	        return _this;
	    }
	    ...
	    _createClass(TodoList, [{
	        ...
	        key: 'activeDaysLoad',
	        value: function activeDaysLoad() {
	            var _this2 = this;

	            var month = this.store.getState().date.getMonth() + 1;
	            fetch('/days/get/active', {
	                ...
	                _this2.setState({ activeDays: res });
	            }).catch(alert);
	        }
	    }, {
	        key: 'todosLoad',
	        value: function todosLoad() {
	            this.store.dispatch(act.todosLoad(this.store.getState().date));
	            this.activeDaysLoad();
	        }
	    }, {
	        key: 'todoToggle',
	        value: function todoToggle(item) {
	            item.done = !item.done;
	            this.store.dispatch(act.todosChange(item));
	            if (item.done) this.showSuccessMessage("Задача выполнена! Вы молодец!");else this.showSuccessMessage("Задача не выполнена обратно");
	        }
	    }, {
	        key: 'todosAddItem',
	        value: function todosAddItem(newItem) {
	        ...
	        value: function showSuccessMessage(msg) {
	            ...
	            this.setState({ messageTimer: setTimeout(function () {
	                    _this3.setState({ messageToShow: "" });
	                }, 5000) });
	        }
	    }, {
	        key: 'todosDeleteItem',
	        value: function todosDeleteItem(id) {
	            this.store.dispatch(act.todosDelete(id));
	            this.showSuccessMessage("Задача удалена из списка");
	            this.todosLoad();
	        }
	    }, {
	        key: 'todosSetEditableItem',
	        value: function todosSetEditableItem(id) {
	            this.setState({ editableItemID: id });
	        }
	    }, {
	        key: 'todosChangeItem',
	        value: function todosChangeItem(item) {
	            this.store.dispatch(act.todosChange(item));
	        ...
	        key: 'todosDeleteDone',
	        value: function todosDeleteDone() {
	        ...
	        key: 'todosDeleteOnDay',
	        value: function todosDeleteOnDay(day) {
	            this.store.dispatch(act.todosDeleteOnDay(day));
	            this.showSuccessMessage("Задачна этот день удалены");
	            this.todosLoad();
	        }
	    }, {
	        key: 'handleVoiceControl',
	        value: function handleVoiceControl(text) {
	            var arr = text.split(" ");
	            if (arr[0].toLowerCase() == "добавить" && arr[1].toLowerCase() == "задачу") {
	                ...
	                if (arr.length > 2) {
	                    ...
	                    for (i = 2; i < arr.length; i++) {
	                        if (arr[i].toLowerCase() != "время") task += arr[i] + " ";else break;
	                    }
	                    if (arr[i] == "время") {
	                        if (arr[i + 1]) time = arr[i + 1];
	                        if (arr[i + 2]) time += ":" + arr[i + 2];else time += ":00";
	                    }
	                }
	        ...
	        key: 'onDayChange',
	        value: function onDayChange(e, day) {
	            this.store.dispatch(act.dateSet(day));
	            this.todosLoad();
	        }
	    }, {
	        key: 'onMonthChange',
	        value: function onMonthChange(date) {
	            this.store.dispatch(act.dateSetMonth(date.getMonth()));
	            this.todosLoad();
	        }
	    }, {
	        key: 'todosExportToICS',
	        value: function todosExportToICS() {}
	    }, {
	        key: 'render',
	        value: function render() {
	            var _this4 = this;

	            var iconTime = _react2.default.createElement('span', { className: 'glyphicon glyphicon-time' });
	            var alertBox = this.state.messageToShow ? _react2.default.createElement(
	                'div',
	                { className: 'alert alert-success todo-alert' },
	            ...
	            for (var i = 0; i < todos.length; i++) {
	                ...
	                if (item.id !== this.state.editableItemID) {
	                    items.push(_react2.default.createElement(_TodoListItem2.default, { item: item, key: item.id,
	                    ...
	                    items.push(_react2.default.createElement(_TodoListItemEdit2.default, { item: item, key: item.id,
	            ...
	            if (!items.length) {
	                items.push(_react2.default.createElement(_TodoListItem2.default, { item: { name: "Нет задач" }, key: 0, empty: true }));
	            }

	            var activeDays = {
	                active: function active(day) {
	                    return _this4.state.activeDays.indexOf(day.getDate()) != -1 && _this4.store.getState().date.getMonth() == day.getMonth();
	                }
	            };
	                    ...
	                    _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(
	                                ...
	                                _react2.default.createElement(_reactDayPicker2.default, {
	                                    ...
	                                    selectedDays: function selectedDays(day) {
	                                        return _reactDayPicker.DateUtils.isSameDay(_this4.store.getState().date, day);
	                                    }
	                                })
	                            ),
	                            _react2.default.createElement(
	                                ...
	                                _react2.default.createElement(
	                                    ...
	                                    { className: 'btn btn-primary btn-block',
	                                        onClick: function onClick() {
	                                            return _this4.onDayChange(null, new Date());
	                                        } },
	                                    'Сегодня'
	                                ),
	                                _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(
	                                ...
	                                _react2.default.createElement(
	                                    ...
	                                    _react2.default.createElement(
	                                        ...
	                                        _react2.default.createElement(
	                                            ...
	                                            _react2.default.createElement(
	                                                'th',
	                                                { className: 'todo-item-time' },
	                                                'Time'
	                                            ),
	                                            _react2.default.createElement(
	                                                'th',
	                                                { width: '100%' },
	                                                this.store.getState().date.toDateString()
	                                            )
	                                        )
	                                    ),
	                                    _react2.default.createElement(
	                                ...
	                                _react2.default.createElement(_TodoListAdd2.default, { handleTaskAdd: this.todosAddItem.bind(this) })
	                            )
	                        ),
	                        _react2.default.createElement(
	                            'td',
	                            ...
	                            _react2.default.createElement(
	                                ...
	                                _react2.default.createElement(
	                                    'a',
	                                    { href: '/logout', className: 'btn btn-default btn-block' },
	                                    'Выход'
	                                ),
	                                _react2.default.createElement(
	                                    'div',
	                                ...
	                                _react2.default.createElement(_TodoVoiceControl2.default, { onControl: this.handleVoiceControl.bind(this) })
	                            ),
	                            alertBox
	                        )
	                    )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TodoListItem = function (_React$Component) {
	    ...
	    function TodoListItem(props) {
	        ...
	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(TodoListItem).call(this, props));
	    ...
	    _createClass(TodoListItem, [{
	        key: "handleTodoClick",
	        value: function handleTodoClick(event) {
	        ...
	        value: function render() {
	            ...
	            var timeCellContent = item.done ? _react2.default.createElement("span", { className: "glyphicon glyphicon-ok" }) : item.time ? item.time.slice(0, 5) : _react2.default.createElement("span", { className: "glyphicon glyphicon-time" });
	            var trClass = !!item.done ? "success" : "";

	            if (!this.props.empty) return _react2.default.createElement(
	                "tr",
	                { className: trClass },
	                _react2.default.createElement(
	                    "td",
	                ...
	                _react2.default.createElement(
	                    "td",
	                    { width: "100%", onClick: this.handleTodoClick },
	                    item.name,
	                    _react2.default.createElement(
	                        "div",
	                        { className: "todo-item-control" },
	                        _react2.default.createElement("span", { className: "glyphicon glyphicon-pencil", onClick: this.handleEdit }),
	                        _react2.default.createElement("span", { className: "glyphicon glyphicon-remove", onClick: this.handleDelete })
	                    )
	                )
	            );else return _react2.default.createElement(
	                "tr",
	                null,
	                _react2.default.createElement("td", { className: "todo-item-time" }),
	                _react2.default.createElement(
	                    "td",
	                    { width: "100%" },
	                    item.name
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TodoListAdd = function (_React$Component) {
	    _inherits(TodoListAdd, _React$Component);

	    function TodoListAdd(props) {
	        _classCallCheck(this, TodoListAdd);

	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(TodoListAdd).call(this, props));

	        _this.handleSubmit = _this.handleSubmit.bind(_this);
	        return _this;
	    }

	    _createClass(TodoListAdd, [{
	        key: "componentDidMount",
	        value: function componentDidMount() {
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                "form",
	                { method: "post", onSubmit: this.handleSubmit, className: "task-add-block form-horizontal" },
	                _react2.default.createElement("input", { type: "text", defaultValue: "", ref: "name", className: "form-control", placeholder: "Имя..." }),
	                _react2.default.createElement(
	                    "div",
	                    ...
	                    _react2.default.createElement(
	                        "div",
	                        { className: "col-sm-6" },
	                        _react2.default.createElement("input", { type: "time", defaultValue: "", ref: "time", className: "form-control" })
	                    ),
	                    _react2.default.createElement(
	                        "div",
	                        { className: "col-sm-6" },
	                        _react2.default.createElement("input", { type: "submit", defaultValue: "", className: "form-control" })
	                    )
	                )
	            );
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TodoListItemEdit = function (_React$Component) {
	    _inherits(TodoListItemEdit, _React$Component);

	    function TodoListItemEdit(props) {
	        _classCallCheck(this, TodoListItemEdit);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(TodoListItemEdit).call(this, props));
	    }

	    _createClass(TodoListItemEdit, [{
	        key: "handleSave",
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    "td",
	                    { colSpan: "2", className: "form-horizontal" },
	                    _react2.default.createElement(
	                        "div",
	                        { className: "form-group" },
	                        _react2.default.createElement(
	                            "div",
	                            { className: "col-sm-4" },
	                            _react2.default.createElement("input", { type: "time", defaultValue: this.props.item.time,
	                                ref: "time", className: "form-control", tabIndex: "2" })
	                        ),
	                        _react2.default.createElement(
	                            "div",
	                            { className: "col-sm-8" },
	                            _react2.default.createElement("input", { type: "text", defaultValue: this.props.item.name,
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            "div",
	                            { className: "col-sm-4" },
	                            _react2.default.createElement("input", { type: "button", defaultValue: "Отмена", tabIndex: "3",
	                        ...
	                        _react2.default.createElement(
	                            "div",
	                            { className: "col-sm-8" },
	                            _react2.default.createElement("input", { type: "button", defaultValue: "Сохранить", tabIndex: "4",
	...
	exports.default = TodoListItemEdit;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TodoVoiceControl = function (_React$Component) {
	    _inherits(TodoVoiceControl, _React$Component);

	    function TodoVoiceControl(props) {
	        _classCallCheck(this, TodoVoiceControl);

	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(TodoVoiceControl).call(this, props));

	        _this.state = { speaking: false };
	        return _this;
	    }

	    _createClass(TodoVoiceControl, [{
	        key: 'handleClick',
	        value: function handleClick() {
	            var self = this;
	            ya.speechkit.recognize({
	                doneCallback: function doneCallback(text) {
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    'div',
	                    { className: 'voice-button', onClick: this.handleClick.bind(this) },
	                    _react2.default.createElement('i', { className: 'glyphicon glyphicon-volume-up' })
	                ),
	    ...
	    return TodoVoiceControl;
	}(_react2.default.Component);

	exports.default = TodoVoiceControl;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DayPicker = __webpack_require__(45);
	var DateUtils = __webpack_require__(52);
	var LocaleUtils = __webpack_require__(53);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Caption = __webpack_require__(46);
	...
	var _Month = __webpack_require__(49);
	...
	var _DateUtils = __webpack_require__(52);

	var DateUtils = _interopRequireWildcard(_DateUtils);

	var _LocaleUtils = __webpack_require__(53);
	...
	var DayPicker = function (_Component) {
	  ...
	  _createClass(DayPicker, [{
	    ...
	    key: 'showMonthAndCallHandler',
	    value: function showMonthAndCallHandler(d, callback) {
	      var _this2 = this;

	      this.showMonth(d, function () {
	        if (callback) {
	          callback();
	        }
	    ...
	    key: 'showNextYear',
	    value: function showNextYear(callback) {
	      var nextMonth = DateUtils.addMonths(this.state.currentMonth, 12);
	      this.showMonthAndCallHandler(nextMonth, callback);
	    }
	  }, {
	    key: 'showPreviousYear',
	    value: function showPreviousYear(callback) {
	      var nextMonth = DateUtils.addMonths(this.state.currentMonth, -12);
	      this.showMonthAndCallHandler(nextMonth, callback);
	    }
	  }, {
	    ...
	    value: function render() {
	      ...
	      var attributes = _objectWithoutProperties(_props3, ['locale', 'canChangeMonth', 'onDayClick']);
	      ...
	      return _react2.default.createElement(
	        ...
	        canChangeMonth && _react2.default.createElement(_Navbar2.default, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Weekdays = __webpack_require__(50);
	...
	function Month(_ref) {
	  ...
	  var weeks = (0, _Helpers.getWeekArray)(month, firstDayOfWeek);
	  return _react2.default.createElement(
	    'div',
	    { className: className },
	    _react2.default.cloneElement(captionElement, captionProps),
	    _react2.default.createElement(_Weekdays2.default, { locale: locale, localeUtils: localeUtils }),
	    _react2.default.createElement(
	      'div',
...
/***/ function(module, exports, __webpack_require__) {
	...
	function getModifiersForDay(d, modifierFunctions) {
	  ...
	  if (modifierFunctions) {
	    ...
	    try {
	      for (var _iterator = Object.keys(modifierFunctions)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
...
/***/ function(module, exports) {
	...
	exports.todosLoad = todosLoad;
	exports.todosToggle = todosToggle;
	exports.todosAdd = todosAdd;
	exports.todosChange = todosChange;
	exports.todosDelete = todosDelete;
	exports.todosDeleteDone = todosDeleteDone;
	exports.todosDeleteAll = todosDeleteAll;
	exports.todosDeleteOld = todosDeleteOld;
	exports.todosDeleteOnDay = todosDeleteOnDay;
	exports.dateSet = dateSet;
	exports.dateNextDay = dateNextDay;
	exports.dateSetMonth = dateSetMonth;
	function todosLoad(date) {
	    return {
	        type: 'TODOS_LOAD',
	        date: date
	    };
	...
	function todosDeleteDone() {
	    return {
	        type: 'TODOS_DELETE_DONE'
	    };
	}

	function todosDeleteAll() {
	    return {
	        type: 'TODOS_DELETE_ALL'
	    };
	}

	function todosDeleteOld(date) {
	    return {
	...
	function todosDeleteOnDay(date) {
	    return {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var dateReducer = function dateReducer() {
	    var state = arguments.length <= 0 || arguments[0] === undefined ? new Date() : arguments[0];
	    var action = arguments[1];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _applyMiddleware = __webpack_require__(71);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(67)(global || window || this);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DOMLazyTree = __webpack_require__(115);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactDOMDebugTool = __webpack_require__(140);
